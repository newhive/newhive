...
GITHUB_USER = 'iliaTalalai'
GITHUB_REPO = 'hivedev/NewHive'
GITHUB_LOGIN = 'newduke'
GITHUB_PASSWORD = 'FILL IN'
PIVOTAL_TOKEN = '06a848c38fb35d8ef1d58ef5ded0cef9'
PIVOTAL_PROJECT_ID = '1107348'

###### NOTE FOR JORDAN FROM ILIA
  #pivotal username: iliatalalai1
  #pivotal password: ilia262
