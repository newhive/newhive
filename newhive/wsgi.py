...
assets_env.register('app.js', 'jquery_misc.js', 'rotate.js', 'hover.js', 'drag.js', 'dragndrop.js', 'colors.js', 'util.js',
    'compiled.asset_paths.js', 'jplayer/jquery.jplayer.js', filters='yui_js', output='../lib/app.js')
