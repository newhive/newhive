...
var main = function() {
    if(navigator.userAgent.indexOf("Firefox") != -1 && parseInt(navigator.appVersion) < 5)
        if(prompt("You're using an oldish version of Firefox. Click OK to get the newest version"))
