...
var main = function() {
    ...
    var bg_set = function(c) {
        ...
        $('#bg').css('background-color', c); Hive.Exp.background.color = c;
    }
...
Hive.embed_code = function() {
    ...
    if(m = c.match(/^https?:\/\/www.youtube.com\/.*?v=(.*)$/))
        ...
        app = { type : 'hive.html', content :
            '<iframe src="http://player.vimeo.com/video/' + m[2] + '?title=0&amp;byline=0&amp;portrait=0" border="0" style="width:100%; height:100%"></iframe>' };
