...
/* Hack to prevent iframe in an App from capturing mouse events
...
var main = function() {
    ...
    var embed_menu = hover_menu($('#insert_embed'), $('#menu_embed'), { no_close : true });
...
Hive.embed_code = function() {
    ...
    if(m = c.match(/^https?:\/\/www.youtube.com\/watch\?v=(.*)$/))
