...
drag = $special.drag = {
	...
	init: function( event ){
        ...
        // original element offsets ... who wants fixed coordinates?
        dd.originalPos = [$(this).position().left, $(this).position().top];
        // original element dimensions
        dd.originalDims = [$(this).width(), $(this).height()];
		dd.dragging = null;
	...
	properties: function( event, dd, ia ){		
        ...
        obj.originalPos = dd.originalPos;
        obj.originalDims = dd.originalDims;
...
// currenly only used for rotating stuff
