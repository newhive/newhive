...
hover_menu = function(handle, drawer, options) {
    ...
    o.open = function() {
        ...
        if(!o.opened) {
            ...
            var left = hp.left + drawer.outerWidth() > $(window).width() ?
...
tool_tip = function(tool, tip, above) {
    ...
    o.show = function() {
        var x = tool.offset().left + tool.outerWidth() / 2 - o.drawer.outerWidth() / 2;
        var y = o.tool.offset().top + (above ? -5 - o.drawer.outerHeight() : o.tool.outerHeight() + 5);
