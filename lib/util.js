...
function showDialog(name) {
    ...
    $('#dialog_shield').show().add('#firefox_warning .btn_dialog_close')
...
$(document).ready(function () {
  ...
  $('#dia_share_shield, #btn_dialog_close').click(function(){
      $('#dia_share_shield, #dia_share').hide();
  });
