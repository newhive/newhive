...
StripeCheckout.require = function() {
    var modules = {}, cache = {};
...
StripeCheckout.require.define({"vendor/cookie": function(exports, require, module) {
        var cookie = {};
        var pluses = /\+/g;
...
StripeCheckout.require.define({"vendor/ready": function(exports, require, module) {
...
StripeCheckout.require.define({"lib/helpers": function(exports, require, module) {
        (function() {
            ...
            helpers = {userAgent: window.navigator.userAgent,escape: function(value) {
                ...
                },iOSVersion: uaVersionFn(/(?:iPhone OS |iPad; CPU OS )(\d+)_\d+/),iOSMinorVersion: uaVersionFn(/(?:iPhone OS |iPad; CPU OS )\d+_(\d+)/),iOSBuildVersion: uaVersionFn(/(?:iPhone OS |iPad; CPU OS )\d+_\d+_(\d+)/),androidWebkitVersion: uaVersionFn(/Mozilla\/5\.0.*Android.*AppleWebKit\/([\d]+)/),androidVersion: uaVersionFn(/Android (\d+)\.\d+/),firefoxVersion: uaVersionFn(/Firefox\/(\d+)\.\d+/),chromeVersion: uaVersionFn(/Chrome\/(\d+)\.\d+/),safariVersion: uaVersionFn(/Version\/(\d+)\.\d+ Safari/),iOSChromeVersion: uaVersionFn(/CriOS\/(\d+)\.\d+/),iOSNativeVersion: uaVersionFn(/Stripe\/(\d+)\.\d+/),ieVersion: uaVersionFn(/(?:MSIE |Trident\/.*rv:)(\d{1,2})\./),isiOSChrome: function() {
...
StripeCheckout.require.define({"lib/rpc": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"lib/uuid": function(exports, require, module) {
        (function() {
            var S4;
            S4 = function() {
...
StripeCheckout.require.define({"lib/pixel": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"vendor/base64": function(exports, require, module) {
...
StripeCheckout.require.define({"lib/tracker": function(exports, require, module) {
        (function() {
            ...
            config = {enabled: false,tracingEnabled: false,eventNamePrefix: "checkout.",distinctId: uuid.generate(),mixpanelKey: null};
            stateParameters = {};
            tracker = {};
            ...
            tracker.track = {outerOpen: function(parameters) {
                    var requiredKeys;
                    requiredKeys = ["key"];
            ...
            tracker.trace = {trigger: function(eventName, args) {
                    var EXCLUDED_EVENTS;
            ...
            tracker.state = {setUIType: function(type) {
...
StripeCheckout.require.define({"outer/lib/fallbackRpc": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"outer/lib/utils": function(exports, require, module) {
        (function() {
            ...
            module.exports = {$: $,$$: $$,hasAttr: hasAttr,trigger: trigger,addClass: addClass,hasClass: hasClass,css: css,insertBefore: insertBefore,insertAfter: insertAfter,append: append,remove: remove,parents: parents,resolve: resolve,text: text}
        }).call(this)
    }});
StripeCheckout.require.define({"outer/controllers/app": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"outer/controllers/button": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"outer/controllers/checkout": function(exports, require, module) {
        (function() {
            var Checkout, FallbackView, IframeView, TabView, cookie, helpers, __bind = function(fn, me) {
                return function() {
                    return fn.apply(me, arguments)
                }
            };
            ...
            Checkout = function() {
                ...
                function Checkout(tokenCallback, host) {
                    ...
                    if (helpers.isFallback()) {
                        ...
                        path = "/v3/fallback/6UQ6gx0KTH1syE44E6yZA.html"
                    } else {
                        path = "/v3/lB3wUljfuCi9MIXuTlvvg.html";
                        if (Math.random() < .1) {
                            path = "/v3/nocdn-hlnqFn7LdeQOmPLkwVzeA.html"
                        }
                        shouldPopup = helpers.isSupportedMobileOS() && !(helpers.isNativeWebContainer() || helpers.isiOSWebView() || helpers.isAndroidWebapp() || helpers.isiOSBroken());
                        if (shouldPopup) {
                            viewClass = TabView
                        } else {
                ...
                Checkout.prototype.open = function(options) {
                    ...
                    return this.view.open(options, function(_this) {
                        return function(status) {
                            ...
                            _this.view = new IframeView(_this.onToken, _this.host, "/v3/lB3wUljfuCi9MIXuTlvvg.html");
...
StripeCheckout.require.define({"outer/controllers/tokenCallback": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"outer/views/fallbackView": function(exports, require, module) {
        (function() {
...
StripeCheckout.require.define({"outer/views/iframeView": function(exports, require, module) {
        (function() {
            ...
            IframeView = function(_super) {
                ...
                IframeView.prototype.closed = function() {
                    var _base;
...
StripeCheckout.require.define({"outer/views/tabView": function(exports, require, module) {
        (function() {
            ...
            TabView = function(_super) {
                ...
                TabView.prototype.closed = function() {
                    ...
                    clearTimeout(this.tokenTimeout);
                    if (this.token != null) {
                        return this.onToken(this.token)
                    }
                };
                return TabView
            }(View);
...
StripeCheckout.require.define({"outer/views/view": function(exports, require, module) {
        (function() {
...
(function() {
    ...
    require = StripeCheckout.require;
    Button = require("outer/controllers/button");
    App = require("outer/controllers/app");
    if (((_ref = StripeCheckout) != null ? _ref.__app : void 0) == null) {
        StripeCheckout || (StripeCheckout = {});
        StripeCheckout.__app = app = new App;
        StripeCheckout.open = app.open;
        StripeCheckout.configure = app.configure;
        if (((_ref1 = StripeCheckout) != null ? _ref1.__host : void 0) && StripeCheckout.__host !== "") {
            app.setHost(StripeCheckout.__host)
        }
    }
    Button.load(StripeCheckout.__app)
}).call(this);
